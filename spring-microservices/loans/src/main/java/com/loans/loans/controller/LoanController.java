...
@Tag(
        name = "CRUD REST APIs for Loans in SevenStack",
        description = "CRUD REST APIs in SevenStack to CREATE, UPDATE, FETCH AND DELETE loan details"
)
@RestController
...
public class LoanController {
    ...
    public LoanController(ILoanService iLoanService){
        this.iLoansService = iLoanService;
    }
    ...
    @Operation(
            ...
            description = "REST API to create new loan inside SevenStack"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
