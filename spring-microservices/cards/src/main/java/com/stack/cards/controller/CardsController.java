package com.stack.cards.controller;
...
import com.stack.cards.dto.ErrorResponseDTO;
import com.stack.cards.dto.ResponseDTO;
...
@Tag(
        name = "CRUD REST APIs for Cards in Seven stack",
        description = "CRUD REST APIs in Seven stack to CREATE, UPDATE, FETCH AND DELETE card details"
)
@RestController
...
public class CardsController {
    ...
    @Operation(
            ...
            description = "REST API to create new Card inside SevenStack"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
